...
function Inventario() {
  ...
  const cardClass = `card border-secondary shadow mb-4 ${tema === 'claro' ? 'bg-white text-dark' : 'bg-dark text-white'}`;
  ...
  return (
    <div className={`container-fluid pb-5 ${tema === 'claro' ? 'text-dark' : 'text-white'}`}>
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <button 
          className={`btn ${mostrarForm ? 'btn-secondary' : `btn-${colorPrincipal}`} fw-bold shadow-sm`}
      ...
      {mostrarForm && (
        <div className={`card border-${colorPrincipal} mb-4 shadow animate__animated animate__fadeIn ${tema === 'claro' ? 'bg-white' : 'bg-dark'}`}>
          <div className={`card-header bg-${colorPrincipal} text-white fw-bold`}>Registrar Nuevo Producto</div>
          <div className="card-body">
            <form onSubmit={manejarGuardar} className="row g-3">
              ...
              <div className="col-md-3 d-flex align-items-end">
                <button type="submit" className={`btn btn-${colorPrincipal} w-100 fw-bold`}>✅ Guardar Producto</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div className={cardClass}>
        <div className="card-body p-2">
          <div className="input-group">
            ...
            <input type="text" className={`form-control bg-transparent border-0 ${tema === 'claro' ? 'text-dark' : 'text-white'}`} 
      ...
      <div className={`card border-secondary shadow ${tema === 'claro' ? 'bg-white' : 'bg-dark'}`}>
        <div className="table-responsive">
          <table className={`table table-hover align-middle mb-0 ${tema === 'claro' ? 'table-light' : 'table-dark'}`}>
            <thead className={`${tema === 'claro' ? 'text-dark' : 'text-secondary'} small`}>
              <tr>
              ...
              {productosFiltrados.map(p => (
                <tr key={p.id}>
                  ...
                  <td className="text-center">
                    <span className={`badge rounded-pill ${p.stockActual < 5 ? 'bg-danger' : `bg-${colorPrincipal}`}`} style={{fontSize: '0.9rem'}}>
                      {p.stockActual} pz
                    </span>
                  </td>
      ...
      {showModal && (
        <div className="modal show d-block" style={{ backgroundColor: 'rgba(0,0,0,0.7)' }}>
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className={`modal-content border-secondary shadow-lg ${tema === 'claro' ? 'bg-white text-dark' : 'bg-dark text-white'}`}>
              ...
              <form onSubmit={manejarActualizar}>
                <div className="modal-body row g-3">
                  <div className="col-md-4">
                    ...
                    <input type="text" className={inputClass} value={productoEditado.codigoBarras} 
                  ...
                  <div className="col-md-8">
                    ...
                    <input type="text" className={inputClass} value={productoEditado.nombre} 
                  ...
                  <div className="col-md-3">
                    ...
                    <select className={selectClass} value={productoEditado.proveedor.id} 
                  ...
                  <div className="col-md-3">
                    ...
                    <input type="number" step="0.01" className={inputClass} value={productoEditado.precioCompra} 
                  ...
                  <div className="col-md-3">
                    ...
                    <input type="number" step="0.01" className={inputClass} value={productoEditado.precioVenta} 
                  ...
                  <div className="col-md-3">
                    ...
                    <input type="number" className={inputClass} value={productoEditado.stockActual} 
